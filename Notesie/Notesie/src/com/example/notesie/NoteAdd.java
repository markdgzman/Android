...
public class NoteAdd extends ActionBarActivity {
    ...
    public void addNote(View view){
    	...
    	Note note = noteOperations.addNote(title.getText().toString(), text.getText().toString());
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View rootView = inflater.inflate(R.layout.fragment_note_add,
					container, false);
			return rootView;
		}
	}
